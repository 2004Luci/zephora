...
const CitySearch = () => {
    ...
    const handleSelect = (placeData: string) => {
        const [lat, lon, name, country] = placeData.split("|");
    ...
    return (
        <>
            <Button variant="outline" className="relative w-full justify-star text-sm text-muted-foreground sm:pr-12 md:w-40 lg:w-64 cursor-pointer" onClick={() => setOpen(true)}>
